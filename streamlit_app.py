"""
ZwQ Inventory & Recipe Dashboard — Streamlit App
Main page: 6-tab dashboard (Ingredient Master, Recipe Management, Food Costing, Cross-Utilization, Supplier Intelligence, Analytics)
"""
import streamlit as st
import pandas as pd
from utils import compute_dashboard_data

st.set_page_config(page_title="ZwQ Inventory & Recipe Dashboard", page_icon="📦", layout="wide")
